...
mibBuilder.addMibSources(builder.DirMibSource('/opt/nornir/mibs'))
print(mibBuilder.getMibSources())
print('done')

print('Loading MIB modules...'),
mibBuilder.loadModules(
    'SNMPv2-MIB', 'SNMP-FRAMEWORK-MIB', 'SNMP-COMMUNITY-MIB', 'IP-MIB', 'JUNIPER-MIB'
    )
print('done')
...
print('MIB symbol name lookup by OID: '),
oid, label, suffix = mibView.getNodeName((1,3,6,1,4,1,2636))
print(oid, label, suffix)
